# -*- coding: utf-8 -*-
#
# Modelacion documentation build configuration file, created by
...
project = u'Modelacion'
copyright = u'2011, Carlos Cordoba'
...
exclude_patterns = ['_build', 'Texto/Muchas particulas']
...
htmlhelp_basename = 'Modelaciondoc'
...
latex_documents = [
  ('index', 'Modelacion.tex', u'Modelacion Documentation',
